                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-8 text-center">
                            <h1 class="display-6 text-uppercase fw-medium mb-4 cursor-default">General Conditions of Sale</h1>
                            <p class="text-muted text-uppercase tracking-wide mb-0 cursor-default">ALIIRADA - 𝐌𝐔𝐒𝐋𝐈𝐌 𝐂𝐋𝐎𝐓𝐇𝐄𝐒 𝐟𝐨𝐫 𝐰𝐨𝐦𝐞𝐧 🕊️</p>
                        </div>
                    </div>
                </div>
            </div>
